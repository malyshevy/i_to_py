...
def transcoding():
    with open('test_file.txt', 'rb') as text:
        source_text = text.read()
    detect_text = detect(source_text)
    encoding_text = detect_text['encoding']
    result_text = source_text.decode(encoding_text)
    with open('test_file.txt', 'w', encoding='utf8') as text:
        text.write(result_text)


transcoding()
with open('test_file.txt', 'r', encoding='utf8') as text:
    print(text.read())
